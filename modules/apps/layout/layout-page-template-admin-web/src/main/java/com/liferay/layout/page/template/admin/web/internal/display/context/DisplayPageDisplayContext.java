...
import com.liferay.layout.page.template.util.comparator.LayoutPageTemplateCollectionAndLayoutPageTemplateEntryCreateDateComparator;
import com.liferay.layout.page.template.util.comparator.LayoutPageTemplateCollectionAndLayoutPageTemplateEntryNameComparator;
...
public class DisplayPageDisplayContext {
	...
	private OrderByComparator<Object> _getCollectionsOrderByComparator() {
		...
		if (Objects.equals(getOrderByCol(), "create-date")) {
			return new LayoutPageTemplateCollectionAndLayoutPageTemplateEntryCreateDateComparator(
				orderByAsc);
		}
		else if (Objects.equals(getOrderByCol(), "name")) {
			return new LayoutPageTemplateCollectionAndLayoutPageTemplateEntryNameComparator(
				orderByAsc);
		}
