...
public class LayoutPageTemplateCollectionsTreeNodeItemSelectorView
	...
	public void renderHTML(
		...
		LayoutPageTemplateCollectionsTreeNodeDisplayContext layoutPageTemplateCollectionsTreeNodeDisplayContext = new LayoutPageTemplateCollectionsTreeNodeDisplayContext((HttpServletRequest)servletRequest, themeDisplay);

		_reactRenderer.renderReact(
			new ComponentDescriptor(
				"{SelectLayoutPageTemplateCollection} from layout-page-template-item-selector-web"),
				HashMapBuilder.<String, Object>put(
					"itemSelectorSaveEvent", "selectFolder"
				).put(
					"layoutPageTemplateCollections", layoutPageTemplateCollectionsTreeNodeDisplayContext.getLayoutPageTemplateCollectionJSONArray()
				).build(),
