	...
	public static java.util.List<Object>
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"getDisplayPageCollectionsAndLayoutPageTemplateEntries",
				_getDisplayPageCollectionsAndLayoutPageTemplateEntriesParameterTypes11);
	...
	public static int
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"getDisplayPageCollectionsAndLayoutPageTemplateEntriesCount",
				_getDisplayPageCollectionsAndLayoutPageTemplateEntriesCountParameterTypes12);
	...
	public static int
		...
		try {
			MethodKey methodKey = new MethodKey(
				LayoutPageTemplateEntryServiceUtil.class,
				"getDisplayPageCollectionsAndLayoutPageTemplateEntriesCount",
				_getDisplayPageCollectionsAndLayoutPageTemplateEntriesCountParameterTypes13);
