 ...
 */
public class
	LayoutPageTemplateCollectionAndLayoutPageTemplateEntryCreateDateComparator
	...
	public LayoutPageTemplateCollectionAndLayoutPageTemplateEntryCreateDateComparator() {
		this(true);
	}
