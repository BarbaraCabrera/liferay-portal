...
@Meta.OCD(
	id = "com.liferay.layout.admin.web.internal.configuration.LayoutUtilityPageAdminWebConfiguration",
	localization = "content/Language",
	name = "layout-utility-page-admin-web-configuration-name"
)
public interface LayoutUtilityPageAdminWebConfiguration {
