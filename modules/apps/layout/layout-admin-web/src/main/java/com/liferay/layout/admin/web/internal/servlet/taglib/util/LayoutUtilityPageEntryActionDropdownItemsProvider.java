...
public class LayoutUtilityPageEntryActionDropdownItemsProvider {
	...
	public LayoutUtilityPageEntryActionDropdownItemsProvider(
		...
		_itemSelector = (ItemSelector)_httpServletRequest.getAttribute(
			LayoutUtilityPageActionKeys.ITEM_SELECTOR);
		_layoutUtilityPageAdminWebConfiguration =
			(LayoutUtilityPageAdminWebConfiguration)
	...
	private String _getItemSelectorURL() {
		ItemSelectorCriterion itemSelectorCriterion =
			UploadItemSelectorCriterion.builder(
				...
				_layoutUtilityPageAdminWebConfiguration.thumbnailExtensions()
			).maxFileSize(
				UploadServletRequestConfigurationHelperUtil.getMaxSize()
			).portletId(
				LayoutUtilityPageActionKeys.ADD_LAYOUT_UTILITY_PAGE_ENTRY
			).repositoryName(
				LanguageUtil.get(_themeDisplay.getLocale(), "utility-page")
			).url(
				PortletURLBuilder.createActionURL(
					_renderResponse
				).setActionName(
	...
	private final LayoutUtilityPageAdminWebConfiguration
		_layoutUtilityPageAdminWebConfiguration;
