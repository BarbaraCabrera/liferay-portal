...
package com.liferay.portlet.configuration.icon.permissions.configuration;
...
@Meta.OCD(
	id = "com.liferay.portlet.configuration.icon.permissions.configuration.RoleVisibilityConfiguration",
